...
export const shapeNames: Record<Nail['shape'],string> = {round:'短圆',oval:'椭圆',almond:'杏仁',square:'方形',coffin:'梯形'}
export const finishNames: Record<Nail['finish'],string> = {gloss:'亮面',jelly:'果冻',matte:'哑光',glitter:'细闪',chrome:'镜面',cat:'猫眼'}
export const patternNames: Record<Nail['pattern'],string> = {none:'纯净',french:'法式',gradient:'渐变',dots:'波点',lines:'线条'}
export const palette = [
  ['奶雾','#E8CCC2'],['玫瑰','#B65C70'],['莓果','#763F53'],['绯红','#AC303B'],
  ['杏桃','#D69782'],['焦糖','#98694F'],['燕麦','#D7BE9B'],['奶油','#F4E9D8'],
  ['抹茶','#84917A'],['森林','#365B52'],['雾蓝','#8AA8B8'],['深海','#385C7A'],
  ['芋泥','#B5A1C5'],['紫夜','#67527B'],['银灰','#A5ABAD'],['墨黑','#303238'],
] as const
...
export const inspirations = [
  {name:'玫瑰的来信',caption:'奶粉 · 细边法式',colors:['#C98996','#E8CCC2','#B65C70'],finish:'gloss',pattern:'french'},
  {name:'月光落在指尖',caption:'紫夜 · 猫眼微光',colors:['#67527B','#B5A1C5','#8C729E'],finish:'cat',pattern:'none'},
  {name:'抹茶与奶油',caption:'柔绿 · 俏皮波点',colors:['#84917A','#F4E9D8','#365B52'],finish:'gloss',pattern:'dots'},
  {name:'海边的一封信',caption:'雾蓝 · 柔和渐变',colors:['#8AA8B8','#E1E8E8','#385C7A'],finish:'gloss',pattern:'gradient'},
] as const
