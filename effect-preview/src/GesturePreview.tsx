...
export function GesturePreview({design,selected,hand,onSelect,onDetail,affected=[]}:{design:Design;selected:number;hand?:'left'|'right';affected?:number[];onSelect:(i:number)=>void;onDetail:(i:number)=>void}){
